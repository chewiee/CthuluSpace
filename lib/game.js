(function () {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText(this.score, 300, 375);
    ctx.font = "30px Anton";
  ...
  Game.prototype.remove = function (object) {
    if (object instanceof CthuluSpace.Cthulu) {
      this.cthulu.splice(this.cthulu.indexOf(object), 1);    this.advanceBackground(delta);
  ...
  Game.prototype.advanceBackground = function (delta) {
    ...
    var offsetY = -(0.5 + (this.score / 1000)) * velocityScale;
    ...
    if (this.cthulu[0].pos[1] >= Game.DIM_Y) {
      this.gameOver = true;
    }
  };
